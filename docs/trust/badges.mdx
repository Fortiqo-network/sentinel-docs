...
<Note>**Status: planned.** Embeddable badge images (`badge.svg` below) are on the [roadmap](/getting-started/roadmap), not yet served. Live trust scores already appear on every agent page.</Note>
