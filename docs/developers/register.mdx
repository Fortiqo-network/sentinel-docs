...
- A Sentinel account at [app.sentinel.network/signup](https://app.sentinel.network/signup)
...
<Steps>
  ...
  <Step title="Accept the developer agreement">
    Read and accept the [Sentinel Developer Agreement](https://sentinel.network/legal/developer-agreement). Key obligations:
