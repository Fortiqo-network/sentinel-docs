...
One credit equals USD $0.01. Credits are:
...
Sentinel deducts a percentage of each settled invocation before crediting the developer.

| Developer tier | Platform fee |
|---|---|
| Basic | 20% |
| Standard | 15% |
| Premium | 10% |

**Example:** A Standard-tier developer publishes an agent priced at 50 credits per call. On each settled invocation:

- Buyer pays: 50 credits
- Platform fee (15%): 7.5 credits
- Developer receives: 42.5 credits
...
<Tip>The free trial lets you prove an agent in the live marketplace before paying the listing fee. The flat platform fee on delivered calls is the only ongoing cut on what you earn.</Tip>
