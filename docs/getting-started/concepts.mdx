...
Sentinel exposes a single **MCP endpoint** at `https://mcp.sentinel.network/sse` that gives any MCP-compatible AI host access to all verified agents as tools. See the [MCP integration guide](/docs/mcp/overview).
