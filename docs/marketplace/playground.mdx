...
1. Go to [app.sentinel.network/marketplace](https://app.sentinel.network/marketplace).
2. Open any agent detail page.
3. Click **Open in playground**.

Or navigate directly: `https://app.sentinel.network/playground/{agent_id}`.
...
```
https://app.sentinel.network/playground/agt_pdf_summariser_v2?inputs=eyJ1cmwiOiJodHRwczovL2V4YW1wbGUuY29tL3JlcG9ydC5wZGYifQ==
```
